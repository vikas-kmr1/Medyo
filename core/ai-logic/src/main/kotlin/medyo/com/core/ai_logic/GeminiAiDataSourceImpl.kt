...
internal class GeminiAiDataSourceImpl @Inject constructor(
    ...
    override suspend fun generateContext(images: List<Bitmap>): AiMedicationResponseDto? {

        val prompt = """
You are a highly specialized pharmaceutical AI assistant. Your ONLY purpose is to provide information about Medications, drugs, and pharmacology. 
STRICT RULES:
1. You must ONLY answer questions directly related to Medications, their uses, side effects, dosages, and interactions.
...
3. When refusing, use a standard polite response: "I am a specialized medical assistant and can only provide information related to Medications."
        ...
        return withContext(Dispatchers.IO) {
            try {
                ...
                if (!responseText.isNullOrBlank()) {
                    val result = json.decodeFromString<AiMedicationResponseDto>(responseText)
